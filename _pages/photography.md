...
nav_order:
---
<!-- inline CSS (hover + lightbox styling) -->
<style>
/* Hover effect */
.img-clickable img {
  cursor: pointer;
...
<div class="row">
    <div class="col-sm-8">
        <div class="img-clickable" onclick="openLightbox(this)">
...
<!-- lightbox HTML + JS (once per page) Add this at the bottom of the page: -->
